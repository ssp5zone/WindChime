...
/**
 * @version 1.0
 * @version 1.1 (JAR fix - Get input stream as local URL.)
 * @category Player
 * @description A ClipPlayer. The simplest of all, uses inbuilt sound library.
...
public class ClipPlayer implements Player {
	...
	private void setAudioInputStream(String source) {
		try {
			this.ais = AudioSystem.getAudioInputStream(getClass().getResource(file));
